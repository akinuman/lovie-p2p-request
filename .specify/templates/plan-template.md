...
**Constraints**: [domain-specific, e.g., <200ms p95, <100MB memory, offline-capable, integer-cents money handling, responsive UX, or NEEDS CLARIFICATION]  
...
|-----------|------------|-------------------------------------|
| [e.g., extra non-core feature] | [current need] | [why assignment scope would otherwise fail] |
| [e.g., additional architectural layer] | [specific problem] | [why a simpler approach is not sufficient] |
